...
<div id="main" class="padding32 sizing">
    ...
    <x-View::Card icon="bi-star" open="off">
        ...
        <x-View::Input title="密码输入" type="password" name="password" placeholder="请输入一段密码" left="auto" />
        <x-View::Input title="邮箱输入" type="email" name="email" placeholder="请输入一段邮箱" left="auto" />
