@php
    ...
    // 类型相关
    $allowedTypes = [ 'text', 'password', 'email', 'phone', 'number', 'datetime-local', 'date', 'time', 'select', 'textarea', 'code', 'color', 'switch', 'radio', 'checkbox', 'markdown', 'code', 'verify', 'agree', 'upload', 'button' ]; // 允许的类型
    ...
    $disableIconTypes = [ 'textarea', 'code', 'switch', 'radio', 'checkbox', 'markdown', 'code', 'verify', 'agree', 'upload', 'button' ]; // 禁用图标的类型
    ...
    $disableMethodTypes = [ 'textarea', 'code', 'switch', 'radio', 'checkbox', 'markdown', 'code', 'verify', 'agree', 'upload', 'button' ]; // 禁用方法的类型
